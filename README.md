...
* The iCE40 is clocked at 16MHz and PLL is not used. However, the controller can receive just short of 16kB of buffer data in one shot at up to 100MHz (definitely not supported on RPI! and not particularly useful, but possible!) as the SPI slave and FIFO receiver are asynchronous!
